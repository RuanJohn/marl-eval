...
data_dir = "data/gen-matrax-tabular/merged_data/metrics.json"
png_plot_dir = "plots/gen-matrix-tabular/png/"
pdf_plot_dir = "plots/gen-matrix-tabular/pdf/"

legend_map = {
    "ff_ippo_tabular_split": "FF IPPO - Separate Policies",
    "ff_ippo_tabular": "FF IPPO - Shared Policy",
    "ff_ppo_central_tabular": "FF PPO Central",
}
...
fig = probability_of_improvement(
    ...
    algorithms_to_compare=[
        ["ff_ppo_central_tabular", "ff_ippo_tabular"],
        ["ff_ppo_central_tabular", "ff_ippo_tabular_split"],
        ["ff_ippo_tabular", "ff_ippo_tabular_split"],
    ],
...
for task in tasks:
    ...
    fig.figure.savefig(f"{png_plot_dir}{task}_agg_return.png", bbox_inches="tight")
    if SAVE_PDF:
        fig.figure.savefig(f"{pdf_plot_dir}{task}_agg_return.pdf", bbox_inches="tight")
